  	...
  	<div class="explore-tour">
      			...
      			<div class="frame-wrapper">
        				<div class="beijing-xian-shanghai-best-parent">
          					...
          					<div class="frame-parent3">
            						...
            						<div class="div">4.9/5 935 Latest reviews</div>
          					</div>
          					<div class="div">Tour Code: ODY-CN-2301</div>
          					<div class="div">Destination: Beijing, Xi’an, Shanghai</div>
        				</div>
      			</div>
    		</div>
    		...
    		<div class="frame-parent7">
      			<div class="about-this-trip-parent">
        				...
        				<div class="this-well-packed-golden">This well-packed Golden China Tour is perfect for those looking for a snapshot of vast China with a limited schedule. Beginning in Beijing, you will marvel at the Forbidden City and the Great Wall. Then, take a bullet train to Xi'an to see the famous Terracotta Warriors before heading to Shanghai to explore the Bund waterfront, the peaceful Yu Garden, and the former French Concession.</div>
      			</div>
      			<div class="about-this-trip-parent">
        				...
        				<div class="frame-parent8">
          					...
          					<div class="image-13-parent">
            						...
            						<div class="forbidden-city-temple-of-heav-wrapper">
              							<div class="forbidden-city-temple">Forbidden City, Temple of Heaven, Great Wall, Hutong, Having Lunch at a Local's Home</div>
            						</div>
          					</div>
          					<div class="image-13-parent">
            						<div class="wrapper">
            						...
            						<div class="frame-parent15">
              							<div class="your-trip-ideas-parent">
                								...
                								<div class="eg-desired-destinations-must-wrapper">
                  									<div class="days">Eg. Desired destinations, must see attractions, honeymoon or anniversary, travel with children...</div>
                								</div>
              							</div>
              							<div class="your-trip-ideas-parent">
          					...
          					<div class="frame-parent20">
            						<div class="day-1-beijing-arrival-parent">
              							...
              							<div class="welcome-to-china-container">
                								<p class="welcome-to-china">Welcome to China! Touch down in Beijing and meet your guide for a one-hour private transfer to your downtown hotel.</p>
                								<p class="welcome-to-china">If you are landing at Daxing International airport, after meeting the guide and checking your luggage, you may spend some time sightseeing at the new airport of Beijing to discover its marvelously laid Chinese elements.</p>
              							</div>
            						</div>
            						<div class="overview-wrapper">
              							<img class="weuiarrow-filled-icon1" alt="" src="../asset/weui_arrow-up-filled.png">
    		...
    		<div class="frame-parent52">
      			<div class="frame-parent53">
        				<div class="material-symbolscomputer-outl-parent">
          					<img class="material-symbolscomputer-outl-icon" alt="" src="../asset/material-symbols_computer-outline.png">
