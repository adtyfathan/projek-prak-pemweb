                    ...
                    <div class="frame-wrapper1">
                        <div class="group-parent">
                            <?php
								...
								$result = mysqli_query($koneksi, "SELECT * FROM tours ORDER BY jumlah_like DESC LIMIT 4");

								if (mysqli_num_rows($result) > 0) {
									while ($data = mysqli_fetch_assoc($result)) {
										echo '
											<div class="beijing-best-tour-parent">
                                <img class="beijing-best-tour" alt="" src="data:image/jpeg;base64,' . base64_encode($data['gambar_tempat']) . '">

                                <div class="frame-parent5">
                                    <div class="beijing-xian-shanghai-best-parent">
                                        <div class="beijing-xian">'.$data['nama_tempat'].' Tours</div>
                                        <div class="best-china-small">'.$data['jumlah_hari'].' Days</div>
                                ...
                                <div class="frame-parent26">
                                    <div class="renata-parent">
                                        ...
                                        <div class="renato-cristine-faro-parent">
                                            <div class="renato-cristine">'.$row['nama'].'</div>
                                        </div>
                                    </div>
