    ...
    <div class="home">
            ...
            <div class="weuiarrow-filled-parent">
                ...
                <div class="frame-parent4">
                    ...
                    <div class="check-now-wrapper">
                        <div class="cungkuo-tour">Check Now</div>
                    </div>
                </div>
        ...
        <div class="frame-parent5">
            <div class="contact-a-travel-expert-parent">
                <div class="div">Contact a Travel Expert</div>
                <div class="frame-inner">
                </div>
            </div>
            <div class="contact-a-travel-expert-parent">
                <div class="div">+ 1 233 2492329 (US)</div>
                <div class="frame-inner">
                </div>
            </div>
            <div class="contact-a-travel-expert-parent">
                <div class="div">+61 2 93924832349 (AU)</div>
                <div class="frame-inner">
                </div>
            </div>
            <div class="contact-a-travel-expert-parent">
                <div class="div">+61 232 423 567 (AU)</div>
                <div class="frame-inner">
                </div>
            </div>
            <div class="custimer-service-wrapper">
                <div class="div">24/7 Custimer Service</div>
            </div>
        </div>
            ...
            <div class="frame-parent7">
                ...
                <div class="frame-parent8">
                    ...
                    <div class="view-more-wrapper">
                        <div class="tailor-my-trip"><a href="top-10.php">View More</a></div>
                    </div>
                </div>
            </div>
            <div class="frame-parent7">
        ...
        <div class="frame-parent29">
            <div class="popular-private-china-tours-parent">
                <b class="insight-china-travel">Customize Your Trip With A Local Expert</b>
                <b class="to-1-service-with">1-to-1 service with guaranteed responses within 24 hours</b>
            </div>
            <div class="tailor-my-trip-wrapper">
                <div class="tailor-my-trip">Tailor My Trip</div>
            </div>
            <div class="frame-wrapper6">
                <div class="frame-parent30">
                    <div class="image-6-parent16">
                        ...
                        <div class="traveler-wrapper">
                            <div class="frame-parent31">
                                <div class="traveler-wrapper">
                                    <div class="traveler">Xiao Ditya</div>
                                </div>
                    ...
                    <div class="image-6-parent16">
                        <img class="image-6-icon18" alt="" src="../asset/Ghuo Zacky.jpg">

                        <div class="traveler-wrapper">
                            <div class="frame-parent31">
                                <div class="traveler-wrapper">
                                    <div class="traveler">Ghuo Zacky</div>
                                </div>
                                <div class="senior-travel-expert">Senior Travel Expert</div>
                            </div>
                        </div>
        ...
        <div class="frame-parent37">
            <div class="what-our-clients-say-parent">
                <div class="china-odyssey-tours">What Our Clients Say</div>
                <div class="to-1-service-with">"Great Customized Service", "Trip of A Lifetime", "Exceed All
                    Expectations"</div>
            </div>
                    ...
                    <div class="frame-parent49">
                        <div class="frame-parent50">
                            <div class="hot-destinations-parent">
                                <b class="china-odyssey-tours">HOT DESTINATIONS</b>
                            ...
                            <div class="company-parent">
                                <b class="china-odyssey-tours">COMPANY</b>
                            ...
                            <div class="resource-parent">
                                <b class="china-odyssey-tours">RESOURCE</b>
                                <div class="frame-wrapper16">
                                    <div class="beijing-parent">
                        ...
                        <div class="tablerclock-filled-parent">
                            ...
                            <div class="were-at-your-service-parent">
                                ...
                                <div class="parent">
                                    <div class="china-odyssey-tours">+1 273 83492332</div>
                                    <div class="china-odyssey-tours">+61 2 934840234</div>
                                    <div class="china-odyssey-tours">+61 234 842 921</div>
                                </div>
                            </div>
                        </div>
                    </div>
