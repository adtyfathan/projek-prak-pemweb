...
<head>
    ...
    <link rel="stylesheet" href="../css/final-reserv.css" />
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700&display=swap" />
</head>

<body>
    <div class="final-reserv">
        ...
        <div class="frame-parent3">
            ...
            <div class="frame-parent4">
                ...
                <div class="your-reservation-hase">Your Reservation Hase been record! Check Your email for detail. We
                    can’t wait to meet you</div>
            </div>
        </div>
        <div class="final-reserv-inner">
            <div class="frame-wrapper1">
                <div class="frame-parent5">
                    <div class="frame-parent6">
                        <div class="frame-parent7">
                            <div class="hot-destinations-parent">
                                <b class="hot-destinations">HOT DESTINATIONS</b>
                            ...
                            <div class="company-parent">
                                <b class="hot-destinations">COMPANY</b>
                            ...
                            <div class="resource-parent">
                                <b class="hot-destinations">RESOURCE</b>
                                <div class="frame-wrapper2">
                                    <div class="beijing-parent">
                        ...
                        <div class="tablerclock-filled-parent">
                            ...
                            <div class="were-at-your-service-parent">
                                <b class="hot-destinations">We’re at your service</b>
                                <div class="parent">
                                    <div class="hot-destinations">+1 273 83492332</div>
                                    <div class="hot-destinations">+61 2 934840234</div>
                                    <div class="hot-destinations">+61 234 842 921</div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="frame-parent9">
            <div class="the-beauty-of-china-parent">
                <div class="hot-destinations">The Beauty of China</div>
